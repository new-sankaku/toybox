...
|------|------|------|
| 1 | ベースプロンプト | 全Agent共通 |
| 2 | ロールプロンプト | ORCHESTRATOR/DIRECTOR/LEADER/WORKER |
...
### ORCHESTRATOR（prompts/role/orchestrator.md）

| 項目 | 内容 |
|------|------|
| 責務 | Phase間の遷移管理、全体進捗監視 |
| 判断基準 | Phase完了判定は厳格に、不明点はHumanに確認 |
| 権限 | DIRECTORへの指示、Phase遷移決定、プロジェクト一時停止 |
