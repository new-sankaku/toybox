...
#   size      Text+のSizeは画面幅に対する比。0.065 ≒ 70px
#   edgeW     Thicknessは文字サイズに対する比。0.035 ≒ 2.5px（黒縁2〜4pxの定番）
...
ENTRIES = [
    ...
    dict(name="笑い", marker="[wｗ]", sample="wそれはずるい", over=dict(
        ...
        fill="#ffd400", size=0.072, edgeC="#3a2000", edgeW=0.023,
        glowC="#241400")),
    dict(name="大爆笑", marker="[wｗ]{2,}", sample="wwやめてくれ", over=dict(
        font="HGPSoeiKakupoptai", style="Regular",
        fill="#ff9c1a", size=0.095, edgeC="#2b1200", edgeW=0.012,
    ...
    dict(name="煽り", marker="[#＃]{3,}", sample="###まさかの展開", over=dict(
        font="BIZ UDPGothic", style="Bold",
        fill="#ffe600", size=0.100, tracking=1.00,
    ...
    dict(name="リスナーのコメント", marker="[:：]", sample=":それ知ってる", over=dict(
        style="Regular", size=0.040, fillA=0.96,
        edgeOn=0,
    ...
    dict(name="ナレーション", marker="[=＝]", sample="=このあと事件が起きる", over=dict(
        ...
        size=0.048, tracking=1.14, fill="#f3f3f0",
    ...
    dict(name="引用・回想", marker="[\"”]", sample="\"あの時こう言った", over=dict(
        ...
        size=0.054, tracking=1.10, fill="#ece5d6", fillA=0.92,
...
def _look(name, cat, **over):
    return dict(name=name, cat=cat, over=over)
...
LOOKS = [
    ...
    _look("ドン！（超極太）", "定番",
          font="Noto Sans JP Black", style="Regular", tracking=0.94, fill="#ffffff", fillA=1.00,
          edgeOn=1, edgeC="#000000", edgeW=0.026, edgeRound=1, edge2On=0,
    ...
    _look("ほのぼの（太い白縁）", "かわいい・ポップ",
          ...
          glowOpacity=0.45, shadowOn=0, bandOn=0),
    _look("はずむ", "かわいい・ポップ",
          font="RocknRoll One", style="Regular", size=0.07, tracking=0.98, leading=0.9,
    ...
    _look("シトラス", "かわいい・ポップ",
          font="Mochiy Pop One", style="Regular", size=0.074, tracking=0.96, leading=0.88,
    ...
    _look("まる座布団", "かわいい・ポップ",
          font="Zen Maru Gothic Black", style="Regular", size=0.06, tracking=1.00,
    ...
    _look("シール", "かわいい・ポップ",
          font="Zen Maru Gothic", style="Bold", size=0.066, tracking=1.00, leading=0.92,
    ...
    _look("子供っぽい（クレヨン）", "こども・ベビー",
          font="Yusei Magic", style="Regular", size=0.07, tracking=1.02, leading=0.94,
    ...
    _look("赤ちゃん（ミルク）", "こども・ベビー",
          font="Hachi Maru Pop", style="Regular", size=0.062, tracking=1.06, leading=1.00,
    ...
    _look("よちよち（水色）", "こども・ベビー",
          font="Zen Maru Gothic", style="Bold", size=0.062, tracking=1.04, leading=0.96,
    ...
    _look("おえかき（クレヨン線）", "こども・ベビー",
          font="Yomogi", style="Regular", size=0.06, tracking=1.06, leading=0.98,
    ...
    _look("つみき（原色）", "こども・ベビー",
          font="Mochiy Pop One", style="Regular", size=0.068, tracking=1.00, leading=0.9,
    ...
    _look("ほっぺ（もちもち）", "こども・ベビー",
          font="Zen Maru Gothic Black", style="Regular", size=0.066, tracking=1.00,
    ...
    _look("手書きツッコミ", "手書き・ゆるい",
          font="Yusei Magic", style="Regular", size=0.068, tracking=1.02, leading=0.92,
          ...
          shadowOpacity=0.45, bandOn=0, bandEdgeOn=0),
    _look("ひとりごと", "手書き・ゆるい",
          font="Yomogi", style="Regular", size=0.056, tracking=1.06, leading=0.98,
    ...
    _look("ゆるふわ実況", "手書き・ゆるい",
          font="Hachi Maru Pop", style="Regular", size=0.062, tracking=1.00, leading=0.94,
    ...
    _look("セクシー（艶）", "色気・大人",
          font="Noto Serif JP", style="Regular", size=0.062, tracking=1.22, leading=1.00,
    ...
    _look("色っぽい（紅）", "色気・大人",
          font="Yu Mincho Demibold", style="Bold", size=0.064, tracking=1.18, leading=0.98,
    ...
    _look("アダルト（黒に金）", "色気・大人",
          font="Shippori Mincho B1 ExtraBold", style="Regular", size=0.06, tracking=1.20,
    ...
    _look("女性的（桜）", "色気・大人",
          font="Klee One SemiBold", style="Regular", size=0.06, tracking=1.10, leading=0.98,
    ...
    _look("ルージュ（口紅）", "色気・大人",
          font="Zen Old Mincho Black", style="Regular", size=0.066, tracking=1.06, leading=0.92,
    ...
    _look("シルク（艶の階調）", "色気・大人",
          font="Noto Sans JP DemiLight", style="Regular", size=0.06, tracking=1.30,
    ...
    _look("妖艶（桃のネオン）", "色気・大人",
          font="Zen Antique", style="Regular", size=0.066, tracking=1.10, leading=0.92,
    ...
    _look("おびえている（ふるえ）", "こわがり・弱気",
          font="Yomogi", style="Regular", size=0.054, tracking=1.08, leading=1.00,
    ...
    _look("おどおど（小さく）", "こわがり・弱気",
          font="Klee One SemiBold", style="Regular", size=0.046, tracking=1.02, leading=1.00,
    ...
    _look("泣きそう（うるむ）", "こわがり・弱気",
          font="Zen Maru Gothic", style="Bold", size=0.058, tracking=1.04, leading=0.98,
    ...
    _look("冷や汗（血の気が引く）", "こわがり・弱気",
          font="Noto Sans JP Medium", style="Regular", size=0.056, tracking=1.14,
    ...
    _look("消え入りそう（薄れる）", "こわがり・弱気",
          font="Noto Sans JP DemiLight", style="Regular", size=0.052, tracking=1.20,
    ...
    _look("戦場（砂・無彩色）", "迫力・極太",
          ...
          shadowOpacity=0.85, bandOn=0),
    _look("大看板", "迫力・極太",
          font="Train One", style="Regular", size=0.086, tracking=1.02, leading=0.88,
    ...
    _look("立体抜き", "迫力・極太",
          font="Rampart One", style="Regular", size=0.08, tracking=1.04, leading=0.96,
    ...
    _look("地響き", "迫力・極太",
          font="Dela Gothic One", style="Regular", size=0.092, tracking=0.88, leading=0.86,
    ...
    _look("うねり", "迫力・極太",
          font="Reggae One", style="Regular", size=0.078, tracking=0.96, leading=0.9,
    ...
    _look("段差", "迫力・極太",
          font="Train One", style="Regular", size=0.082, tracking=1.00, leading=0.9,
          fill="#ffffff", fillA=1.00, fillGradOn=0, fillGradAngle=0.00, edgeOn=1,
          ...
          bandEdgeOn=0),
    _look("傾き縁", "迫力・極太",
          font="Reggae One", style="Regular", size=0.076, tracking=0.98, leading=0.9,
    ...
    _look("額縁", "迫力・極太",
          font="Dela Gothic One", style="Regular", size=0.062, tracking=0.96, leading=1.02,
          fill="#ffffff", fillA=1.00, fillGradOn=0, fillGradAngle=0.00, edgeOn=1,
    ...
    _look("純金（表彰）", "金属・つや",
          font="Dela Gothic One", style="Regular", size=0.07, tracking=0.96, leading=0.9,
          ...
          bandEdgeOn=0),
    _look("白金（記録）", "金属・つや",
          font="Noto Sans JP Black", style="Regular", size=0.068, tracking=0.98, leading=0.9,
          ...
          bandEdgeOn=0),
    _look("古銅（殿堂）", "金属・つや",
          font="HGPGothicE", style="Regular", size=0.068, tracking=0.98, leading=0.9,
    ...
    _look("玉虫（記念）", "金属・つや",
          font="Mochiy Pop One", style="Regular", size=0.068, tracking=0.98, leading=0.9,
          ...
          bandEdgeOn=0),
    _look("茜空（夕景）", "金属・つや",
          font="Zen Maru Gothic Black", style="Regular", size=0.068, tracking=0.98,
          ...
          glowBlur=8.00, glowSpread=0.00, glowOpacity=0.45, shadowOn=0, bandOn=0, bandEdgeOn=0),
    _look("鏡面（クローム）", "金属・つや",
          font="HGPSoeiKakugothicUB", style="Regular", size=0.07, tracking=0.96, leading=0.9,
          ...
          bandEdgeOn=0),
    _look("黒鉄（ガンメタ）", "金属・つや",
          font="Noto Sans JP", style="Bold", size=0.068, tracking=0.98, leading=0.9,
    ...
    _look("昭和看板", "和・レトロ印刷",
          font="Zen Antique", style="Regular", size=0.066, tracking=1.02, leading=0.92,
          ...
          bandEdgeOn=0),
    _look("墨臙脂", "和・レトロ印刷",
          font="Zen Old Mincho Black", style="Regular", size=0.07, tracking=0.96, leading=0.88,
          ...
          bandEdgeOn=0),
    _look("和綴じ", "和・レトロ印刷",
          font="Shippori Mincho B1 ExtraBold", style="Regular", size=0.062, tracking=1.04,
          ...
          bandEdgeOn=0),
    _look("献立札", "和・レトロ印刷",
          font="Shippori Mincho B1 ExtraBold", style="Regular", size=0.06, tracking=1.08,
    ...
    _look("版ズレ", "和・レトロ印刷",
          font="Zen Old Mincho Black", style="Regular", size=0.068, tracking=1.00, leading=0.9,
    ...
    _look("シネマ字幕", "上質・現代",
          font="Noto Sans JP Medium", style="Regular", size=0.046, tracking=1.10, leading=1.00,
    ...
    _look("遺跡（砂色・古紙）", "上質・現代",
          ...
          glowOpacity=0.55, shadowOn=0, bandOn=0),
    _look("鉛筆手帳", "上質・現代",
          font="Klee One SemiBold", style="Regular", size=0.056, tracking=1.06, leading=0.96,
    ...
    _look("現代的（うすい帯）", "上質・現代",
          font="Noto Sans JP Medium", style="Regular", size=0.052, tracking=1.10,
    ...
    _look("上質（余白の細字）", "上質・現代",
          font="Noto Sans JP Light", style="Regular", size=0.05, tracking=1.36, leading=1.10,
    ...
    _look("最先端（画面の表示）", "上質・現代",
          font="Noto Sans JP", style="Regular", size=0.054, tracking=1.42, leading=1.05,
    ...
    _look("雑誌（白地に黒）", "上質・現代",
          font="Noto Serif JP", style="Regular", size=0.054, tracking=1.30, leading=1.08,
    ...
    _look("モード（広い字送り）", "上質・現代",
          font="Noto Sans JP DemiLight", style="Regular", size=0.046, tracking=1.70, leading=1.20,
    ...
    _look("カード（白い錠剤）", "上質・現代",
          font="Noto Sans JP", style="Bold", size=0.048, tracking=1.04, leading=0.98,
    ...
    _look("日付スタンプ", "レトロ・ゲーム",
          font="MS Gothic", style="Regular", size=0.050, tracking=1.12,
...
def python_blocks():
    ...
    base_preset = to_preset(BASE)
    marker_line = "MARKER_CHARS = " + json.dumps(MARKER_CHARS, ensure_ascii=False)
    base_chars_line = "BASE_CHARS = %r" % fit_chars(dict(BASE))
