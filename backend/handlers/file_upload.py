...
def register_file_upload_routes(app:Flask,project_service,intervention_service,upload_folder:str):
    ...
    def list_uploaded_files(project_id:str):
        ...
        files=intervention_service.get_uploaded_files_by_project(project_id)
    ...
    def upload_file(project_id:str):
        ...
        try:
            uploaded_file=intervention_service.create_uploaded_file(
    ...
    def get_uploaded_file_info(file_id:str):
        file_record=intervention_service.get_uploaded_file(file_id)
        if not file_record:
    ...
    def delete_uploaded_file(file_id:str):
        ...
        intervention_service.delete_uploaded_file(file_id)
