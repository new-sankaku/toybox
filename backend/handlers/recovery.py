...
def register_recovery_routes(app: Flask, data_store: DataStore):
    ...
    def get_recovery_status():
        ...
        return jsonify({"interruptedAgents": interrupted_agents, "count": len(interrupted_agents)})
    ...
    def retry_all_interrupted():
        ...
        return jsonify({"success": True, "retriedCount": len(retried), "retriedAgents": retried})
