...
def register_project_routes(app: Flask, data_store: DataStore, sio):
    ...
    def start_project(project_id: str):
        ...
        sio.emit(
            ...
            {"projectId": project_id, "status": "running", "previousStatus": project.get("status", "draft")},
        )
    ...
    def pause_project(project_id: str):
        ...
        sio.emit("project:status_changed", {"projectId": project_id, "status": "paused", "previousStatus": "running"})
    ...
    def resume_project(project_id: str):
        ...
        if current_status == "interrupted":
            ...
            if retried_count > 0:
                get_logger().info(
                    f"resume_project: auto-retried {retried_count} interrupted agents for project {project_id}"
                )
    ...
    def brushup_project(project_id: str):
        ...
        sio.emit("project:status_changed", {"projectId": project_id, "status": "draft", "previousStatus": "completed"})
