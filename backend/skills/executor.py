...
class SkillExecutor:
    def __init__(
        ...
        skill_restrictions: Optional[Dict[str, Dict[str, Any]]] = None,
    ):
...
def create_skill_executor(
    project_id: str, agent_id: str, agent_type: str, working_dir: str, skill_config: Optional[Dict[str, Any]] = None
) -> SkillExecutor:
