...
def generate_openapi_spec()->Dict[str,Any]:
 schemas_list=[
  ...
  ("AdvancedQualityCheckSchema",AdvancedQualityCheckSchema),
  ("ToolExecutionLimitsSchema",ToolExecutionLimitsSchema),
  ("DagExecutionSettingsSchema",DagExecutionSettingsSchema),
  ("TemperatureDefaultsSchema",TemperatureDefaultsSchema),
  ("TokenBudgetSettingsSchema",TokenBudgetSettingsSchema),
  ("ContextPolicySettingsSchema",ContextPolicySettingsSchema),
