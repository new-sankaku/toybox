...
class PrincipleBasedQualityEvaluator:
    ...
    async def evaluate(
        self, output: Dict[str, Any], agent_type: str, project_id: Optional[str] = None
    ) -> Dict[str, Any]:
    ...
    async def _llm_evaluate(
        self, output_text: str, rubrics: str, project_id: Optional[str] = None, usage_category: str = "llm_low"
    ) -> Dict[str, Any]:
