...
async def delete_intervention(intervention_id: str):
    ...
    if success:
        await socket_manager.emit_to_project(
            "intervention:deleted", {"interventionId": intervention_id, "projectId": project_id}, project_id
        )
    return None
...
async def respond_to_intervention(intervention_id: str, data: InterventionResponse):
    ...
    if result:
        await socket_manager.emit_to_project(
            ...
            {"interventionId": intervention_id, "projectId": intervention["projectId"], "message": data.message},
