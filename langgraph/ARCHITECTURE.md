...
| フェーズ | 介入ポイント | 確認内容 |
|---------|------------|---------|
| 企画 | 方向性承認 | ゲームコンセプトは正しいか？ |
| 企画 | 設計承認 | 技術選定・アーキテクチャは適切か？ |
| 企画 | シナリオ承認 | ストーリーは魅力的か？ |
| 企画 | キャラ承認 | キャラクター設定は良いか？ |
| 企画 | 世界観承認 | 世界設定は一貫しているか？ |
| 企画 | タスク計画承認 | タスク分解は適切か？ |
| 開発 | 開発計画承認 | Code Leaderの計画は妥当か？ |
| 開発 | 制作計画承認 | Asset Leaderの計画は妥当か？ |
| 開発 | コード確認 | 生成されたコードは正しいか？ |
| 開発 | アセット確認 | 生成されたアセットは良いか？ |
| 開発 | 統合確認 | 統合結果は動作するか？ |
